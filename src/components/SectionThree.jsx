...
function Section({ imgSrc, title, description }) {
  return (
    <div className="block md:flex items-center md:mt-32 mt-24">
      {/* Image Container */}
      <div className="md:w-1/2 w-full flex justify-center items-center p-0 md:p-4">
        <img
          src={imgSrc}
          alt=""
          className="w-2/3 h-auto md:w-[480px] m-auto"
        />
      </div>
